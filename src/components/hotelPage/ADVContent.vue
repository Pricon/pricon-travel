...
.advcontent_layout .el-carousel__button {
  width: 10px;
  height: 10px;
  border-radius: 5px;
}

.advcontent_layout .is-active .el-carousel__button {
  width: 25px;
}
</style>